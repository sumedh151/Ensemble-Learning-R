...
# Test random_forest_regression function for continuous y
test_that("random_forest_regression function works for continuous y", {
  result_continuous <- random_forest_regression(X_continuous, y_continuous)
  expect_true("predictions" %in% names(result_continuous))
  expect_true("model" %in% names(result_continuous))
})

# Test random_forest_regression function for binary y
test_that("random_forest_regression function works for binary y", {
