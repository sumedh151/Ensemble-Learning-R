...
# Test lasso_regression function for continuous y
test_that("lasso_regression function works for continuous y", {
  result_continuous <- lasso_regression(X_continuous, y_continuous, lambda)
...
# Test lasso_regression function for binary y
test_that("lasso_regression function works for binary y", {
